					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						 <table>
						  <tr>
							<td> Nome: </td>
							<td> &nbsp; </td>
							<td> <input style="width: 450px;" readonly="true" class="form-control" type="text" id="name" name="name" value="<?php echo $organizacionals[0]->name; ?>" />  </td>
						  </tr>
						  <tr>
							<td> Cargo: </td> 
							<td> &nbsp; </td>
							<td> <input style="width: 450px;" readonly="true" class="form-control" type="text" id="cargo" name="cargo" value="<?php echo $organizacionals[0]->cargo; ?>" /> </td>
						  </tr>
						  <tr>
							<td> E-mail: </td> 
							<td> &nbsp; </td>
							<td> <input style="width: 450px;" readonly="true" class="form-control" type="email" id="email" name="email" value="<?php echo $organizacionals[0]->email; ?>" /> </td>
						  </tr>
						  <tr>
							<td> Telefone: </td> 
							<td> &nbsp; </td>
							<td> <input style="width: 450px;" readonly="true" class="form-control" type="text" id="telefone" name="telefone" value="<?php echo $organizacionals[0]->telefone; ?>" /> </td>
						  </tr>
						...
						<table>
							<tr>
							  <td> <br /><br /> <p><h6 align="left"> Deseja realmente Excluir esta Estrutura Organizacional?? </h6></p> </td>
							</tr>
							<tr>
								<td align="left"> <br /> 
