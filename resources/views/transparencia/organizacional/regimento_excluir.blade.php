						...
						<div class="card-body"  style="font-size: 14px;">
							...
							<table>
							    <tr>
								 ...
								 <td> <input style="" class="form-control" type="text" id="title" name="title" value="<?php echo $regimentos[0]->title; ?>" readonly="true" /> </td> 
								</tr> 
								<tr>
								 <td> <br/> <strong> Arquivo: </strong> </td>
								 <td> <br/> <input style="width: 400px;" class="form-control" type="text" id="file_path" name="file_path" readonly="true" value="<?php echo $regimentos[0]->file_path; ?>" /> </td>
								</tr>
							</table>
							...
							<table>
							  <tr>
								...
								<td> <input hidden type="text" class="form-control" id="acao" name="acao" value="excluirRegimentoInterno" /> </td>
							...
							<table>
							 <tr>
							   <td><h6 align="left"><br/><br/>Deseja realmente Excluir este Regimento Interno??</p></td>
							 </tr>
							 <tr>
							  <td align="left"> <br/> 
