...
<div class="container-fluid">
    ...
    <div class="row" style="">
        <div class="col-md-6 text-center">
            <a href="{{route('benspubindex',$unidade->id)}}" class="btn btn-warning" style="font-size:13px;color:white;">Voltar</a>
        </div>
        <div class="col-md-6 text-center">
            <a href="{{route('benspubcreate',$unidade->id)}}" class="btn btn-dark" style="font-size:13px;">Novo</a>
        </div>
    </div>
                    ...
                    <div class="d-flex flex-column" id="headingOne">
                        <div class="d-md-inline-flex justify-content-between border-bottom border-success align-items-center">
                            ...
                            <div class="p-1 text-center">
                                ...
                                <a href="{{route('benspubinativar', array($unidade->id,$bp->id))}}" class="btn btn-danger"> <i class="bi bi-trash"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
