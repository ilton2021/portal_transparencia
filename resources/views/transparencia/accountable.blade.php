...
<div class="container-fluid">
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 text-center">
			...
			<a href="{{route('cadastroDC', $unidade->id)}}" class="btn btn-info btn-sm" style="color: #FFFFFF;"> Alterar <i class="fas fa-edit"></i> </a></li>
			@endif
			@endif
			@endforeach
			@endif
							...
							<div class="d-flex flex-column">
								...
								<div class="d-md-inline-flex justify-content-between border-bottom border-success align-items-center">
									...
									<div class="p-2 text-center">
										<a href="{{asset('storage/')}}/{{$demonstrativoContabel->file_path}}" target="_blank" class="badge badge-success">Download <i class="bi bi-download"></i></a>
									</div>
								</div>
								@endif
								@endforeach
