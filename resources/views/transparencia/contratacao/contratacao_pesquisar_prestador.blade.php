					...
					<h2 class="mb-0">
					 ...
					 <input type="hidden" name="_token" value="{{ csrf_token() }}">
				        <table class="table table-sm" border="0">
						  <tr>
						   <td width="100px"> <select id="funcao" name="funcao" class="form-control" style="width: 200px;"> 
								...
								<tbody>
								  @if(!empty($prestadores))
									...
									<tr>
										...
										<td style="font-size: 11px;">{{$prestador->tipo_contrato}}</td>
										<td style="font-size: 11px;">{{$prestador->tipo_pessoa}}</td>
