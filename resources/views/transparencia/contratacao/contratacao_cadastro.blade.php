				...
				<div class="card">
				  <div class="card-header" id="headingThree">
					<h2 class="mb-0">
					  ...
					  @if(Auth::check())
					  <a href="{{route('transparenciaContratacao', array($unidade->id,1))}}" class="btn btn-warning btn-sm" style="color: #FFFFFF;"> Voltar <i class="fas fa-undo-alt"></i> </a>
					  <a class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('cadastroContratos', $unidade->id)}}"> Novo <i class="fas fa-check"></i></a>
					  @endif
					</h2>
				  </div>
					<div class="card-body">
													...
													<td> 
														...
														<div id="div" class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="font-size: 12px;">
															...
															@foreach($aditivos as $aditivo) 
																@if($contrato->ID === $aditivo->contrato_id)
																	@if($aditivo->opcao == 1)
																		<?php $id += 1; ?>
																		@if($aditivo->ativa == 1)
													 ...
													 <td> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('alterarContratos', array($unidade->id, $contrato->id, $contrato->ID))}}" ><i class="fas fa-edit"></i></a> </td>
													 <td> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('responsavelCadastro', array($unidade->id, $contrato->id))}}"> <i class="fas fa-check"></i></a> </td>
													 <td> <a class="btn btn-danger btn-sm" style="color: #FFFFFF;" href="{{route('excluirContratos', array($unidade->id, $contrato->id, $contrato->ID))}}" > <i class="fas fa-times-circle"></i></a>  </td>
												</tr>
											@endif
											@endforeach	
											</tbody>
										...
										<table class="table table-sm">
											...
											@if ($contrato->tipo_contrato == 'AQUISIÇÃO' && $contrato->tipo_pessoa == 'PESSOA FÍSICA')
												<tr>
													...
													<td> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('alterarContratos', array($unidade->id, $contrato->id, $contrato->ID))}}" ><i class="fas fa-edit"></i></a> </td>
													<td> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('responsavelCadastro', $unidade->id)}}"> <i class="fas fa-check"></i></a> </td>
													<td> <a class="btn btn-danger btn-sm" style="color: #FFFFFF;" href="{{route('excluirContratos', array($unidade->id, $contrato->id, $contrato->ID))}}" > <i class="fas fa-times-circle"></i></a>  </td>
												</tr>
											@endif
											@endforeach	
