                        ...
                        <form action="{{ \Request::route('destroyAditivo'), $unidade->id, $aditivos[0]->id }}"
                            ...
                            <table border="0" class="table table-sm">
                                <tr>
                                    ...
                                    <td> <input class="form-control" style="width: 90px;" readonly="true" type="text"
                                            id="prestador_id" name="prestador_id" value="<?php echo $prestadores[0]->id; ?>"> </td>
                                </tr>
                                <tr>
                                    <td> Prestador: </td>
                                    <td> <input class="form-control" style="width: 500px;" readonly="true" type="text"
                                            id="prestador" name="prestador" value="<?php echo $prestadores[0]->prestador; ?>">
                                </tr>
                                <tr>
                                    <td> <br /> </td>
                                </tr>
                                <tr>
                                    <td> ID do 1º Contrato: </td>
                                    <td> <input class="form-control" style="width: 90px;" readonly="true" type="text"
                                            id="id" name="id" value="<?php echo $contratos[0]->id; ?>" /> </td>
                                    </td>
                                <tr>
                                    @if ($aditivos[0]->opcao == 0)
                                        <td>ID do contrato a excluir:</td>
                                    @elseif($aditivos[0]->opcao == 1)
                                        <td>ID do Aditivo a excluir:</td>
                                    @else
                                        <td>ID do Distrato a excluir:</td>
                                    @endif
                                    <td> <input style="width: 90px;" readonly="true" class="form-control" type="text"
                                            id="file_path" name="file_path" value="<?php echo $aditivos[0]->id; ?>" /> </td>
                                </tr>
                                <tr>
                                    <td> Título: </td>
                                    <td> <input class="form-control" style="width: 500px;" readonly="true" type="text"
                                ...
                                <tr>
                                    ...
                                    <td> <input style="width: 200px;" readonly="true" class="form-control" type="date"
                                            id="inicio" name="inicio" value="<?php echo $aditivos[0]->inicio; ?>" /> </td>
                                </tr>
                                <tr>
                                    <td> Fim: </td>
                                    <td> <input style="width: 200px;" readonly="true" class="form-control" type="date"
                                            id="fim" name="fim" value="<?php echo $aditivos[0]->fim; ?>" /> </td>
                                </tr>
                                <tr>
                                ...
                                <tr hidden>
                                    <td> Yellow Alert: </td>
                                    <td> <input class="form-control" readonly="true" style="width: 200px;" type="number"
                                            id="yellow_alert" name="yellow_alert" value="<?php echo $contratos[0]->yellow_alert; ?>" /> </td>
                                </tr>
                                <tr hidden>
                                    <td> Red Alert: </td>
                                    <td> <input class="form-control" readonly="true" style="width: 200px;"
                                            type="number" id="red_alert" name="red_alert"
                                            value="<?php echo $contratos[0]->red_alert; ?>" /> </td>
                                </tr>
                                <tr>
                                    <td> Arquivo: </td>
                                    <td> <input style="width: 500px;" readonly="true" class="form-control"
                                            type="text" id="file_path" name="file_path"
                                            title="{{ $contratos[0]->file_path }}" value="<?php echo $aditivos[0]->file_path; ?>" /> </td>
                                </tr>
                                <tr>
                            ...
                            <div class="p-2 border border-secondary rounded">
                                <div class="d-flex justify-content-center">
                                    ...
                                    ?>
                                    @if ($aditivos[0]->opcao == 0)
                                        <h6> Deseja realmente <strong style="color: {{$corButao}}"> {{ $acaoStatus }} </strong>
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="javascript:history.back();" id="Voltar" name="Voltar" type="button"
                                        class="btn btn-warning btn-sm" style="margin-top: 10px; color: #FFFFFF;"> Voltar
                                        <i class="fas fa-undo-alt"></i> </a>
                                    <input type="submit"
                                        class="btn btn-<?php echo $acaoStatus == 'Inativar' ? 'danger' : 'success' ?> btn-sm"
                                        style="margin-top: 10px;" value="<?php echo $acaoStatus . ' ' . $tipoArq; ?>" id="statusMudanca"
                                        name="statusMudanca" />
                                </div>
                            </div>
                        </form>
