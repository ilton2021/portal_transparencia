	...
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 col-sm-12 text-center">
			<div class="accordion" id="accordionExample">
				...
				<form action="{{\Request::route('inativarSP'), $unidade->id}}" method="post" id="formid">
						...
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" style="max-width: 100px;" type="type" id="id" name="id" value="<?php echo $superintendentes->id; ?>" disabled="true" />
								</div>
							</div>
						</div>
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" style="max-width: 500px;" type="text" id="name" name="name" value="<?php echo $superintendentes->name; ?>" disabled="true" />
								</div>
							</div>
						</div>
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" style="max-width: 500px;" type="text" id="cargo" name="cargo" value="<?php echo $superintendentes->cargo; ?>" disabled="true" />
								</div>
							</div>
						</div>
					</div>
					<table>
						<tr>
							...
							@if($superintendentes->status_superintendentes == 0)
							  <td> <input hidden type="text" class="form-control" id="acao" name="acao" value="AtivarSuperintendentes" /> </td>
							@else
							  <td> <input hidden type="text" class="form-control" id="acao" name="acao" value="InativarSuperintendentes" /> </td>
							@endif
