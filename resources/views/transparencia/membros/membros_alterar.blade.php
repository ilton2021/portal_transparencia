							...
							<div class="form-row mt-2">
								<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
									...
									<div class="col-md-10 mr-2">
										<input style="max-width: 400px;" class="form-control" type="text" id="name" name="name" value="<?php echo $associado->name; ?>" required />
									</div>
								</div>
							</div>
							<div class="form-row mt-2">
								<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
									...
									<div class="col-md-10 mr-2">
										<input type="text" style="max-width: 300px;" readonly="true" class="form-control" id="tipo_membro" name="tipo_membro" value="Associados Efetivos" required />
									</div>
								</div>
							</div>
						</div>
