	...
	<div class="row" style="margin-top: 25px;">
		<div class="col-md-12 col-sm-12 text-center">
			<div class="accordion" id="accordionExample">
				...
				<form action="{{\Request::route('updateSP'), $unidade->id}}" method="post" id="formid">
						...
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" style="max-width: 450px;" type="text" id="name" name="name" value="<?php echo $superintendentes->name; ?>" />
								</div>
							</div>
						</div>
						<div class="form-row mt-2">
							<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
								...
								<div class="col-md-10 mr-2">
									<input class="form-control" style="max-width: 450px;" type="text" id="cargo" name="cargo" value="<?php echo $superintendentes->cargo; ?>" />
								</div>
							</div>
						</div>
						<div class="form-row mt-2">
