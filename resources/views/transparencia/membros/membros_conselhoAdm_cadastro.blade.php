			...
			<div class="accordion" id="accordionExample">
				<div class="card">
					<div class="card-header d-flex flex-wrap justify-content-center justify-content-md-between" id="headingOne">
						...
						<h5 class="mb-0">
							<li class="list-inline-item"><a id="Novo" name="Novo" type="button" class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoCA', $unidade->id)}}"> Novo <i class="fas fa-check"></i> </a></li>	
									...
									<table class="table table-sm">
										...
										<tbody class="">
											<tr>
												...
												@endif
												<!--td> <center> <a class="btn btn-danger btn-sm" style="color: #FFFFFF;" href="{{route('excluirCA', array($unidade->id, $conselhoAdm->id))}}" ><i class="bi bi-trash"></i></a> </center> </td-->
											</tr>
										</tbody>
										@endforeach	
									</table>
