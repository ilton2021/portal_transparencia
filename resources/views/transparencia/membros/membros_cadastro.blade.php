			...
			<div class="accordion" id="accordionExample">
				<div class="card">
				    <div class="card-header d-flex flex-wrap justify-content-center justify-content-md-between" id="headingOne">
						...
						<h5 class="mb-0">
							<li class="list-inline-item"><a href="{{route('novoAS', $unidade->id)}}" id="Novo" name="Novo" type="button" class="btn btn-dark btn-sm" style="color: #FFFFFF;"> Novo <i class="fas fa-check"></i> </a></li>	
										...
										<tbody class="">
											@foreach($associados as $associado)
												...
												<tr>
													...
													@endif
													<!--td> <center> <a class="btn btn-danger btn-sm" href="{{route('excluirAS', array($unidade->id, $associado->id))}}" ><i class="bi bi-trash"></i></a> </center> </td-->
												</tr>
											</form>
											@endforeach
										</tbody>
