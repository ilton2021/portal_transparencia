			...
			<div class="accordion" id="accordionExample">
				<div class="card">
					<div class="card-header d-flex flex-wrap justify-content-center justify-content-md-between" id="headingOne">
						...
						<h5 class="mb-0">
							<li class="list-inline-item"><a id="Novo" name="Novo" type="button" class="btn btn-dark btn-sm" style="color: #FFFFFF;" href="{{route('novoSP', $unidade->id)}}"> Novo <i class="fas fa-check"></i> </a></li>	
									...
									<table class="table table-sm">
										...
										<tbody class="">
											<tr>
												...
												<td> <center> <a class="btn btn-info btn-sm" style="color: #FFFFFF;" href="{{route('alterarSP', array($unidade->id, $superintendente->id))}}"><i class="fas fa-edit"></i></a> </center> </td>
												@if($superintendente->status_superintendentes == 0)
												<td> <center> <a title="Ativar" class="btn btn-success btn-sm" style="color: #00000;" href="{{route('telaInativarSP', array($unidade->id, $superintendente->id))}}"><i class="fas fa-times-circle"></i></a> </center> </td>
												@else
												<td> <center> <a title="Inativar" class="btn btn-warning btn-sm" style="color: #00000;" href="{{route('telaInativarSP', array($unidade->id, $superintendente->id))}}"><i class="fas fa-times-circle"></i></a> </center> </td>
												@endif
												<!--td> <center> <a class="btn btn-danger btn-sm" style="color: #FFFFFF;" href="{{route('excluirSP', array($unidade->id, $superintendente->id))}}"><i class="bi bi-trash"></i></a> </center> </td-->
											</tr>
										</tbody>
										@endforeach	
									</table>
