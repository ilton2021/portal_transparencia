							...
							<div class="form-row mt-1">
								<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
									...
									<div class="col-md-10 mr-2">
										<input style="max-width: 90px;" readonly="true" class="form-control" type="text" id="id" name="id" value="<?php echo $demonstrativoContaveis[0]->id; ?>" />
									</div>
								</div>
							</div>
							<div class="form-row mt-1">
								<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
									...
									<div class="col-md-10 mr-2">
										<input style="max-width: 500px;" readonly="true" class="form-control" type="text" id="title" name="title" value="<?php echo $demonstrativoContaveis[0]->title; ?>" />
									</div>
								</div>
							</div>
							<div class="form-row mt-1">
								<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
									...
									<div class="col-md-10 mr-2">
										<input style="max-width: 90px;" readonly="true" class="form-control" type="number" id="ano" name="ano" value="<?php echo $demonstrativoContaveis[0]->ano; ?>" />
									</div>
								</div>
							</div>
							<div class="form-row mt-1">
								<div class="form-group col-md-12 d-inline-flex align-items-center flex-wrap flex-md-nowrap">
									...
									<div class="col-md-10 mr-2">
										<input style="max-width: 550px;" readonly="true" class="form-control" type="text" name="file_path" id="file_path" value="<?php echo $demonstrativoContaveis[0]->file_path; ?>" />
									</div>
								</div>
							</div>
						</div>
