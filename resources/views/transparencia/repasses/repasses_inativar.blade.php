					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					 ...
					 <table>
					   <tr>
						 ...
						 @if($repasses[0]->status_repasse == 0)
						   <td> <input hidden type="text" class="form-control" id="acao" name="acao" value="AtivarRepasses" /> </td>
						 @else
						   <td> <input hidden type="text" class="form-control" id="acao" name="acao" value="InativarRepasses" /> </td>
						 @endif
