            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
					...
					<table border="0" class="table-sm" style="line-height: 1.5;" WIDTH="1020">
					  <tr>
					    <td> Título: </td>
						<td> <input class="form-control" style="width: 400px;" type="text" id="title" name="title" value="" required /> </td> 
					  </tr>
					  <tr>
						<td> Arquivo: </td>
					  ...
					  <tr>
						<td> Imagem: </td>
						<td> <input class="form-control" style="width: 400px;" type="file" id="path_img" name="path_img" value="" required /> </td>
					  </tr>
					</table>
					...
					<table>
						 <tr>
						   ...
						   <td> <input hidden type="text" class="form-control" id="acao" name="acao" value="salvarRegulamento" /> </td>
