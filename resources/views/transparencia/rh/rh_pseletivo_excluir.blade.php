			...
			<div class="accordion" id="accordionExample">
				<div class="card">
					<a class="card-header bg-success text-decoration-none text-white bg-success" type="button" data-toggle="collapse" data-target="#SELETIVO" aria-expanded="true" aria-controls="SELETIVO">
						...
						<form action="{{\Request::route('destroySeletivo'), $unidade->id}}" method="post">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<table class="table table-sm">
								...
								<tr>
								  <td> Título: </td>
								  <td> <input class="form-control" readonly="true" style="width: 700px;" type="text" id="title" name="title" value="<?php echo $docSelectiveProcess[0]->title; ?>" /> </td>							  
								</tr>
								<tr>
								  <td> Arquivo: </td>
								  <td> <input class="form-control" readonly="true" style="width: 700px;" type="text" id="file_path" name="file_path" value="<?php echo $docSelectiveProcess[0]->file_path; ?>" /> </td>
								</tr>
								<tr>
								  <td> Ano: </td>
