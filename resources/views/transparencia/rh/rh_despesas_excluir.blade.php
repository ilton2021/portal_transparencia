			...
			<div class="accordion" id="accordionExample">
				<div class="card">
					<a class="card-header bg-success text-decoration-none text-white bg-success" type="button" data-toggle="collapse" data-target="#SELETIVO" aria-expanded="true" aria-controls="SELETIVO">
						...
						<form action="{{\Request::route('destroyDespesasRH'), $unidade->id}}" method="post">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<table class="table table-sm" style="margin-right: 600px;">
								<tr>
								  <td  rowspan="" colspan="1"> Mês: </td>
								  <td> 
									<select style="width: 120px" class="form-control" readonly= "true" id="mes" name="mes">
								  ...
								  <td> Ano: </td>
								  <td> 
									<select style="width:120px;" class="form-control" readonly = "true" id="ano" name="ano">
								  ...
								  <td> Tipo: </td>
								  <td> 	
									  <select style="width:100px;" class="form-control" readonly="true" id="tipo" name="tipo">
							    ...
							    <tr>
								  ...
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant1" name="Quant1" value="<?php echo old('Quant1') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor1" name="valor1" value="<?php echo old('valor1') ?>" required /> </td>
								</tr>
								<tr>
								  ...
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant2" name="Quant2" value="<?php echo old('Quant2') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor2" name="valor2" value="<?php echo old('valor2') ?>" required /> </td>
								</tr>
								<tr>
								  ...
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant3" name="Quant3" value="<?php echo old('Quant3') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor3" name="valor3" value="<?php echo old('valor3') ?>" required /> </td>
								</tr>
								<tr>
								  <td> <input class="form-control" readonly="true" style="width: 250px;" type="text" name="cargo4" id="cargo4" required value="TOTAL" /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant4" name="Quant4" value="<?php echo old('Quant4') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor4" name="valor4" value="<?php echo old('valor4') ?>" required /> </td>
								</tr>
								<tr>  
								...
								<tr>
								  ...
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant5" name="Quant5" value="<?php echo old('Quant5') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor5" name="valor5" value="<?php echo old('valor5') ?>" required /> </td>
								</tr>
								<tr>
								  ...
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant6" name="Quant6" value="<?php echo old('Quant6') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor6" name="valor6" value="<?php echo old('valor6') ?>" required /> </td>
								</tr>
								<tr>
								  <td> <input class="form-control" readonly="true" style="width: 250px;" type="text" name="cargo7" id="cargo7" required value="TOTAL" /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant7" name="Quant7" value="<?php echo old('Quant7') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor7" name="valor7" value="<?php echo old('valor7') ?>" required /> </td>
								</tr>
								<tr>  
								...
								<tr>
								  ...
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant8" name="Quant8" value="<?php echo old('Quant8') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor8" name="valor8" value="<?php echo old('valor8') ?>" required /> </td>
								</tr>
								<tr>
								  <td> <input class="form-control" readonly="true" style="width: 250px;" type="text" name="cargo9" id="cargo9" required value="TOTAL" /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant9" name="Quant9" value="<?php echo old('Quant9') ?>" required /> </td>
								  <td> <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor9" name="valor9" value="<?php echo old('valor9') ?>" required /> </td>
								</tr>
								<tr>  
								  ...
								  <td  rowspan="1" colspan="1"> <input class="form-control" readonly="true" style="width: 100px;" type="number" id="Quant10" name="Quant10" value="<?php echo old('Quant10') ?>" required /> </td>
								  <td  rowspan="2" colspan="5">  <input class="form-control" readonly="true" style="width: 150px;" type="text" id="valor10" name="valor10" value="<?php echo old('valor10') ?>" required /> </td>
								</tr>
							</table>							
							<table>
							 <tr>
