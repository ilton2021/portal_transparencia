            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
					...
					<table border="0" class="table-sm" style="line-height: 1.5;" WIDTH="1020">
					  <tr>
					    <td> Setor: </td>
						<td> <input class="form-control" style="width: 400px;" type="text" id="setor" name="setor" value="" required /> </td> 
					  </tr>
					  
					  <tr>
						<td> Cargo: </td>
						<td> <input class="form-control" style="width: 400px;" type="text" id="cargo" name="cargo" value="" required /> </td> 
					  </tr>
					  
					  <tr>
						<td> Descrição: </td>
						<td> <textarea class="form-control" type="textarea" cols="10" rows="10" id="descricao" name="descricao" value="" required  ></textarea> </td>
					  </tr>
