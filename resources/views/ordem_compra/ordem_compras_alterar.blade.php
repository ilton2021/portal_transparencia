					...
					<table class="table">
                	  <thead>
						<tr> 
							...
							<td> <input type="text" id="numeroSolicitacao" name="numeroSolicitacao" class="form-control" value="<?php echo $processos[0]->numeroSolicitacao; ?>" /> </td>
						</tr>
						<tr>
						...
						<tr> 	
							<td> Nº O.C </td>
							<td> <input type="text" id="numeroOC" name="numeroOC" class="form-control" value="<?php echo $processos[0]->numeroOC; ?>"/> </td>
						</tr>
						<tr> 	
						...
						<tr> 	
							<td> FORNECEDOR </td>
							<td> <input type="text" id="fornecedor" name="fornecedor" class="form-control" value="<?php echo $processos[0]->fornecedor; ?>" /> </td>
						</tr>
						<tr> 	
							<td> CNPJ </td>
							<td> <input type="text" id="cnpj" name="cnpj" class="form-control" value="<?php echo $processos[0]->cnpj; ?> "/> </td>
						</tr>
						<tr> 	
						...
						<tr> 	
							<td> PRODUTO </td>
							<td> <input type="text" id="produto" name="produto" class="form-control" value="<?php echo $processos[0]->produto; ?> "/> </td>
						</tr>
						<tr> 		
						...
						<tr> 	
							...
							<td> <input type="text" id="numeroNotaFiscal" name="numeroNotaFiscal" class="form-control" value="<?php echo $processos[0]->numeroNotaFiscal; ?> "/> </td>
						</tr>
						<tr> 	
							<td> CHAVE DE ACESSO </td>
							<td> <input type="text" id="chaveAcesso" name="chaveAcesso" class="form-control" value="<?php echo $processos[0]->chaveAcesso; ?>" /> </td>
						</tr>
						<tr> 	
							<td> CÓDIGO IBGE </td>
